  ...
  Widget build(BuildContext context) {
    ...
    return CustomTile(
      ...
      title: Text(
        ...
        style:
            TextStyle(color: Colors.black, fontFamily: "Arial", fontSize: MediaQuery.of(context).size.height * 0.03,),
      ),
      ...
      leading: Container(
        constraints: BoxConstraints(maxHeight: MediaQuery.of(context).size.height * 0.1, maxWidth: MediaQuery.of(context).size.width * 0.1,),
        child: Stack(
          children: <Widget>[
            CircleAvatar(
            ...
            Align(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: UniversalVariables.blackColor, width: MediaQuery.of(context).size.width * 0.001,)),
              ),
            )
          ],
        ),
